...
const tabsListVariants = cva(
  "inline-flex items-center justify-center rounded-2xl p-1.5 gap-1 bg-muted/55 ring-1 ring-border/60 shadow-[inset_0_1px_0_var(--clay-highlight)]",
  {
    variants: {
      variant: {
        default: "bg-muted/50",
        pill: "bg-transparent gap-2",
        clay: "bg-background shadow-[0_16px_30px_-24px_var(--foreground)/0.22] ring-1 ring-border/40",
      },
    },
    defaultVariants: {
      variant: "default",
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-[0_12px_24px_-18px_var(--primary)/0.7] data-[state=active]:font-semibold",
